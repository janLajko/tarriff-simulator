...
{{
  ...
  "scope": [
    {{ "key": "2845.20.00","source_label":"note20(a)"}},
    {{ "key": "2845.30.00","source_label":"note20(a)"}}
  ],
  "except": [
    ...
    def __init__(
        ...
        if max_tokens_env:
            try:
                ...
                LOGGER.warning(
                    "Invalid CLAUDE_MAX_OUTPUT_TOKENS=%s; falling back to default %s",
                    max_tokens_env,
                    max_output_tokens,
                )
    ...
    def _convert_note_entries(
        ...
        *,
        ...
        for entry in entries:
            ...
            label = entry.get("source_label") or "note(20)(f)"
